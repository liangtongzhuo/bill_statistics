...
async function funMonth(month) {
  if (month === 6) {
    ...
    dbAddOrder('第三方', `2021/7/1 00:00`, `2021/7/1 00:00`, `地铁`, '郑州地铁', '120', '')
    dbAddOrder('第三方', `2021/7/15 00:00`, `2021/7/15 00:00`, `银行`, '房贷', '3000', '')
    dbAddOrder('第三方', `2021/7/10 00:00`, `2021/7/10 00:00`, `省直公积金`, '额外补充的省直公积金', '400', '')
